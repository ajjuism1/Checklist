...
export const Sidebar: React.FC = () => {
  ...
  const isActive = (path: string) => {
    ...
    if (path === '/versions') return pathname === '/versions' || pathname?.startsWith('/versions/');
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-100 flex flex-col z-40">
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        <Link
          href="/versions"
          className={`sidebar-link ${isActive('/versions') ? 'sidebar-link-active' : 'sidebar-link-inactive'}`}
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Link
          href="/reports"
          className={`sidebar-link ${isActive('/reports') ? 'sidebar-link-active' : 'sidebar-link-inactive'}`}
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
